...
where each source particle has an associated weight $\bar W_j$ and $K$ is 
...
loss of precision. We start by defining a function to simulate the source 
...
use in the approximation method (one could easily implement the naive method 
...
line is "naive" method and the continuous line is the dual-tree method.
