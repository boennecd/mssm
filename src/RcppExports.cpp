...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const std::string >::type alg_inner(alg_innerSEXP);
    rcpp_result_gen = Rcpp::wrap(run_Laplace_aprx(Y, cfix, ws, offsets, disp, X, Z, time_indices_elems, time_indices_len, F, Q, Q0, fam, mu0, n_threads, nu, covar_fac, ftol_rel, N_part, what, trace, KD_N_max, aprx_eps, ftol_abs, la_ftol_rel, ftol_abs_inner, la_ftol_rel_inner, maxeval, maxeval_inner, alg_inner));
    return rcpp_result_gen;
END_RCPP
}
// smoother_cpp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_mssm_run_Laplace_aprx", (DL_FUNC) &_mssm_run_Laplace_aprx, 30},
