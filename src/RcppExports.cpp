...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const arma::uword >::type KD_N_max(KD_N_maxSEXP);
    Rcpp::traits::input_parameter< const double >::type aprx_eps(aprx_epsSEXP);
    rcpp_result_gen = Rcpp::wrap(run_Laplace_aprx(Y, cfix, ws, offsets, disp, X, Z, time_indices_elems, time_indices_len, F, Q, Q0, fam, mu0, n_threads, nu, covar_fac, ftol_rel, N_part, what, trace, KD_N_max, aprx_eps));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_mssm_run_Laplace_aprx", (DL_FUNC) &_mssm_run_Laplace_aprx, 23},
